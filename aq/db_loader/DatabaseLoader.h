...
public:
  ...
  /// \brief initialize a database loader
  /// \param _bd
  /// \param _loader
  /// \param _path
  /// \param _packet_size
  /// \param _end_of_field
  /// \param _csv_format
  DatabaseLoader(const aq::base_t _bd, const std::string& _loader, const std::string& _path, const size_t _packet_size, const char _end_of_field, bool _csv_format);
  
  void generate_ini(); /// \brief generate ini file
